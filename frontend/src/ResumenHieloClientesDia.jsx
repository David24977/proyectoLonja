...
export default function ResumenHieloClientesDia() {
  ...
  const consultarResumen = async (e) => {
    ...
    try {
      const resp = await axios.get(`${API_BASE_URL}/api/hielo-cliente/resumen-dia`, {
        params: { fecha }
      });
  ...
  return (
    <div>
      <h2>Resumen diario de hielo por cliente</h2>
